...
ota_links = _load_module("rezervasyon_ota_link_swarm_from_excel", PROJECT_ROOT / "_ota_link_swarm_from_excel.py")
trip_excel = _load_module("rezervasyon_trip_com_reviews_from_excel", PROJECT_ROOT / "_trip_com_reviews_from_excel.py")
