...
def worker_bind_from_url(worker_url: str, default_host: str = "127.0.0.1", default_port: int = 37777) -> tuple[str, int]:
...
if __name__ == "__main__":
    ...
    host, port = worker_bind_from_url(config.worker_url)
    run_memory_server(db_path=config.db_path, host=host, port=port)
