...
from harness.verification.contract import CheckResult, CheckType, SuccessCheck
...
class CheckRunner:
    ...
    def run(self, check: SuccessCheck) -> CheckResult:
        handler = {
    ...
    def _check_file_exists(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_download_exists(self, check: SuccessCheck) -> CheckResult:
        expected = str(check.value)
    ...
    def _check_variable_has_value(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_variable_equals(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_text_contains(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_always_pass(self, check: SuccessCheck) -> CheckResult:
        return CheckResult(
            passed=True, check_type=check.type,
            expected="always", actual="passed", message="No-op check",
        )

    def _check_url_contains(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_url_equals(self, check: SuccessCheck) -> CheckResult:
        url = self._context.get("current_url", "")
    ...
    def _check_visible_text(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_selector_visible(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_selector_hidden(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_field_has_value(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_status_code(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_json_path_equals(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_response_contains(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_sheet_exists(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_cell_equals(self, check: SuccessCheck) -> CheckResult:
        payload = check.value if isinstance(check.value, dict) else {}
    ...
    def _check_window_exists(self, check: SuccessCheck) -> CheckResult:
        expected = str(check.value)
    ...
    def _check_element_exists(self, check: SuccessCheck) -> CheckResult:
    ...
    def _check_element_text_equals(self, check: SuccessCheck) -> CheckResult:
        expected = check.value.get("value") if isinstance(check.value, dict) else check.value
        actual = (
    ...
    def _check_unknown(self, check: SuccessCheck) -> CheckResult:
        return CheckResult(
...
def run_all_checks(checks: List[SuccessCheck], context: Dict[str, Any] = None) -> List[CheckResult]:
    runner = CheckRunner()
    if context:
